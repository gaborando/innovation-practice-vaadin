...
@Route(value = "person/:samplePersonID?/:action?(edit)", layout = MainView.class)
@PageTitle("Person")
public class PersonView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "person/%d/edit";
    ...
    public PersonView(@Autowired SamplePersonService samplePersonService) {
